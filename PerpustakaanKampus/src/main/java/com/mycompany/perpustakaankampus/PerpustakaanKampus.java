...
public class PerpustakaanKampus {
    ...
    public static void main(String[] args) {
        ...
        Buku buku5 = new Buku(110005, "Pengantar Artificial Intellengece", "Budi Hartono", "Teknologi", 2020, 3, "Buku "Pengantar Artificial Intelligence" membahas dasar-dasar AI, termasuk sejarah, metode, dan aplikasi. Pembaca akan mempelajari teknik-teknik seperti machine learning, deep learning, dan neural networks, serta konsep-konsep seperti natural language processing dan computer vision. Buku ini cocok bagi siapa saja yang ingin memahami AI dan bagaimana teknologi ini dapat diterapkan dalam berbagai bidang.");
